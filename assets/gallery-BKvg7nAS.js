  ...
  var Y = (function () {
      function r(n, t) {
        ...
        if (
          ...
          typeof n == 'string'
            ? ((this.initialSelector = n),
              (this.elements = Array.from(document.querySelectorAll(n))))
            : (this.elements =
                typeof n.length < 'u' && n.length > 0 ? Array.from(n) : [n]),
          ...
          this.elements = Array.from(this.elements).filter(function (i) {
            ...
            return o.indexOf(a) === -1 ? (o.push(a), !0) : !1;
          });
        }
        this.createDomNodes(),
          this.options.close &&
          ...
          this.addEventListener(
            ...
            function (i) {
              if (e.isValidLink(i.currentTarget)) {
                if ((i.preventDefault(), e.isAnimating)) return !1;
          ...
          this.options.disableRightClick &&
            this.addEventListener(
              ...
              function (i) {
                i.target.parentElement.classList.contains('sl-image') &&
                  i.preventDefault();
              }
            ),
          this.options.enableKeyboard &&
            this.addEventListener(
              ...
              this.throttle(function (i) {
                if (
                  ((e.controlCoordinates.swipeDiff = 0),
                ...
                e.isOpen &&
                  ...
                  !e.isAnimating &&
                    ['ArrowLeft', 'ArrowRight'].indexOf(i.key) > -1 &&
                    e.loadImage(i.key === 'ArrowRight' ? 1 : -1));
        ...
        k(r, [
          ...
          },
          {
            ...
            value: function (t) {
              if (this.options.captionSelector.startsWith('+')) {
                ...
                var i = this.options.captionSelector
                  .replace(/^>/, '')
                  .trimStart();
          ...
          },
          {
            ...
            value: function () {
              if (
                ...
                (t = this.domNodes.caption.classList).add.apply(t, S(e));
              }
          ...
          },
          {
            ...
            value: function () {
              ...
              d.addEventListener('load', function (l) {
                ...
                s.setAttribute(
                  'src',
                  this.relatedElements[a].getAttribute(this.options.sourceAttr)
                );
            },
          },
          {
                        ...
                        : setTimeout(function () {
                            ...
                            e.currentImage &&
                              (e.currentImage.setAttribute(
                                'src',
                                a.getAttribute(e.options.sourceAttr)
                              ),
                              e.loadedImages.indexOf(
                                a.getAttribute(e.options.sourceAttr)
                              ) === -1 && e.show(e.domNodes.spinner),
              ...
              o.setAttribute('src', this.currentImage.getAttribute('src')),
                ...
                o.addEventListener('load', function (d) {
                  ...
                  (e.domNodes.image.style.top =
                    ...
                    (e.isOpen = !0);
                  var h, m;
                  typeof e.options.captionSelector == 'string'
                    ? (h =
                        e.options.captionSelector === 'self'
                          ? e.relatedElements[e.currentImageIndex]
                          : e.getCaptionElement(
                              e.relatedElements[e.currentImageIndex]
                            ))
                    : typeof e.options.captionSelector == 'function' &&
                      (h = e.options.captionSelector(
                        e.relatedElements[e.currentImageIndex]
                      )),
                    e.options.captions &&
                      h &&
                      (e.options.captionType === 'data'
                        ? (m = h.dataset[e.options.captionsData])
                        : e.options.captionType === 'text'
                          ? (m = h.innerHTML)
                          : (m = h.getAttribute(e.options.captionsData))),
                    e.options.loop
                      ? e.relatedElements.length === 1
                        ? e.hide(
                    ...
                    t === 1 || t === -1
                      ? (e.options.animationSlide &&
                        ...
                        e.fadeIn(
                          ...
                          e.options.fadeSpeed,
                          function () {
                            (e.isAnimating = !1), e.setCaption(m, s);
                          }
                        ))
                      : ((e.isAnimating = !1), e.setCaption(m, s)),
            ...
            value: function () {
              ...
              if (
                ...
                this.addEventListener(
                  ...
                  'click.' + this.eventNamespace,
                  function (o) {
                    if (!o.currentTarget.tagName.match(/button/i)) return !0;
                    o.preventDefault(),
                      (t.controlCoordinates.swipeDiff = 0),
                      t.loadImage(
                        o.currentTarget.classList.contains('sl-next') ? 1 : -1
                      );
                  }
                ),
                  ...
                  return t.controlCoordinates.mousedown
                    ...
                    : (t.transitionCapable &&
                      ...
                      (t.controlCoordinates.swipeStart =
                        o.pageX || o.touches[0].pageX),
                      (t.controlCoordinates.swipeYStart =
                        o.pageY || o.touches[0].pageY),
                      !1);
                }
              ),
                this.addEventListener(
          ...
          },
          {
            ...
            value: function (t) {
              var e = window.getComputedStyle(t),
                ...
                m = parseFloat(e.paddingLeft),
                u = parseFloat(e.paddingRight);
              return { height: o - d - a - s - l, width: i - c - h - m - u };
            },
          },
          {
            key: 'updateHash',
            ...
            value: function (t, e, o) {
              ...
              if (this.options.captions && t && t !== '' && typeof t < 'u') {
                var a,
                  d =
                    !(
                      (a = o ?? this.options.captionHTML) !== null &&
                      a !== void 0
                    ) || a
                      ? 'innerHTML'
                      : 'innerText';
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                t && t !== !1 && t !== 'nofollow'
                  ? (e = Array.from(this.elements).filter(function (o) {
                    ...
                    for (l.s(); !(c = l.n()).done; ) {
                      ...
                      u &&
                        ...
                        (w(m) === 'object'
                          ...
                          : (m = { passive: !0 })),
                        (s.namespaces[h] = o),
                        s.addEventListener(h.split('.')[0], o, m);
                    }
                  } catch (C) {
                    l.e(C);
                  } finally {
                ...
                c = function h() {
                  ...
                  if ((m -= l) < 0) {
                    ...
                    try {
                      for (u.s(); !(C = u.n()).done; ) {
                        var v = C.value;
                        (v.style.display = 'none'), (v.style.opacity = 1);
                      }
                    } catch (N) {
                      u.e(N);
                    } finally {
              ...
              try {
                for (e.s(); !(o = e.n()).done; ) {
                  ...
                  try {
                    for (a.s(); !(d = a.n()).done; ) {
                      var s = d.value;
                      typeof i.fullyNamespacedEvents < 'u' &&
    ...
    M = Y;
  (g.default = M), (globalThis.SimpleLightbox = Y);
})(X);
const R = W(X),
  F = [
    {
  ...
  _ = document.querySelector('.gallery');
function j(g) {
  return g
    .map(
      ({ preview: w, original: p, description: S }) => `
...
//# sourceMappingURL=gallery-BKvg7nAS.js.map
